    ...
    return ( 
        <div className="fixed w-full h-full top-0 left-0 bg-black/[0.8]	" >
            ...
            <form>
                ...
                <label htmlFor="exampleInputEmail2" className="htmlForm-label inline-block mb-2 text-gray-700">Email address</label>
                ...
                <div className="htmlForm-group mb-6">
                <label htmlFor="exampleInputPassword2" className="htmlForm-label inline-block mb-2 text-gray-700">Password</label>
                <input type="password" className="htmlForm-control block
                    w-full
                    px-3
                    py-1.5
                    text-base
                ...
                <a href="#!"
                    className="text-blue-600 hover:text-blue-700 focus:text-blue-700 transition duration-200 ease-in-out">htmlForgot
                    password?</a>
                </div>
